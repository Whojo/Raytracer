...
int main(int argc, char *argv[])
{
    ...
    Scene scene{
        ...
        { PointLight{Point{6,   -2, 5}, 0.15},
          ...
          PointLight{Point{6, -1.7, 5}, 0.15},
          PointLight{Point{6, -1.6, 5}, 0.15},
          PointLight{Point{6, -1.5, 5}, 0.15},
          PointLight{Point{6, -1.4, 5}, 0.15},
          PointLight{Point{6, -1.3, 5}, 0.15},
          PointLight{Point{6, -1.2, 5}, 0.15},
          PointLight{Point{6, -1.1, 5}, 0.15},
          PointLight{Point{6, -1.0, 5}, 0.15},
          PointLight{Point{6, -0.9, 5}, 0.15},
          PointLight{Point{6, -0.8, 5}, 0.15},
          PointLight{Point{6, -0.7, 5}, 0.15},
          PointLight{Point{6, -0.6, 5}, 0.15},
          PointLight{Point{6, -0.5, 5}, 0.15},
          PointLight{Point{6, -0.4, 5}, 0.15},
          PointLight{Point{6, -0.3, 5}, 0.15},
          PointLight{Point{6, -0.2, 5}, 0.15},
          PointLight{Point{6, -0.1, 5}, 0.15},
